...
function BF_make_rds_grating(distance, numdots, grating_orientation, cyclesperdegree, diameter_size_degrees, arcmindisp, IPD, dotradius_arcmin, texname_static)
