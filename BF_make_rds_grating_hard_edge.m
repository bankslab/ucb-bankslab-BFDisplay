...
function BF_make_rds_grating_hard_edge(distance, numdots, grating_orientation, cyclesperdegree, diameter_size_degrees, arcmindisp, IPD, dotradius_arcmin, texname_static)
