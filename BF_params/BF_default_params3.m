...
%from demo code to experiment code
        ...
        farClip     = 4;       %in meters
            ...
            %Metric distances for image planes, (in meters)
            ...
            disp('*****************************')
            disp('System Params loaded for original 3 plane configuration (near)')
            disp('-9 D lens for left eye, -8.75 D for right eye')
            disp('*****************************')