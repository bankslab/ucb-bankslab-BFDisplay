...
experiment_type='exp_aca'; % Experiment for measuring visual fatigue, staircase method
...
howmanyconditions=3; %number of conditions
howmanycorrfreq=2; %number of corrugation frequencies
trialspercorrfreq=1; %number of trials per one corrugation frequency
...
break_time=10; %Time duration for break between assessments
stimulus_time=2; %Time duration for one stimulus. This is equal to the phase2_duration of scell.
question_time=1; %Time duration for the questions between trials
...
scell{1} = set(s,...
    ...
    'phase2_duration', stimulus_time,... %To access stimulus_time, get phase2_duration
    ...
    'rds_grating_numdots', 800,...
    'rds_grating_orientation', 10,...
    'rds_grating_cpd', 2,...
    'rds_grating_disparity', 2);    %specified in arcmin
...
scell{1+1*howmanycorrfreq} = set(scell{1+1*howmanycorrfreq}, 'condition_num',1+1*howmanycorrfreq,...
    'phase1_verg_dist', NearDist,...
    'phase1_accom_dist', NearDist,...
    'phase2_verg_dist', UberUberNearDist,...
    'phase2_accom_dist', NearDist);

% % Copy to other staircases
scell{1+2*howmanycorrfreq} =  scell{1};
% Set the correct stimulus params
scell{1+2*howmanycorrfreq} = set(scell{1+2*howmanycorrfreq}, 'condition_num',1+2*howmanycorrfreq,...
    'phase1_verg_dist', FarMidDist,...
    'phase1_accom_dist', FarMidDist,...
    'phase2_verg_dist', NearDist,...
    'phase2_accom_dist', NearDist);
