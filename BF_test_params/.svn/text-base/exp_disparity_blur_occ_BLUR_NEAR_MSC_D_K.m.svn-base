...
scell{1} = set(s,...
    ...
    'phase2_duration',0.500,...     % Stimulus duration
...
scell{2} = set(scell{2},'initialValue', 0.005);
scell{2} = set(scell{2},'stepSize',0.01);
% scell{2} = set(scell{2},'stepSize',0.0005);

scell{3} = scell{2};
scell{3} = set(scell{3},'pedestal',0.315); 
scell{3} = set(scell{3},'initialValue', 0.020);
scell{3} = set(scell{3},'stepSize',0.01);
% scell{3} = set(scell{3},'stepSize',-0.005);

scell{4} = scell{3};
scell{4} = set(scell{4},'pedestal',0.335); 
scell{4} = set(scell{4},'initialValue', -0.005);
scell{4} = set(scell{4},'stepSize',-0.0075);
% scell{4} = set(scell{4},'stepSize',-0.005);

scell{5} = scell{2};
scell{5} = set(scell{5},'pedestal',0.355); 
scell{5} = set(scell{5},'initialValue', -0.01);
scell{5} = set(scell{5},'stepSize',-0.011);
...
scell{7} = set(scell{7},'initialValue', -0.01);
