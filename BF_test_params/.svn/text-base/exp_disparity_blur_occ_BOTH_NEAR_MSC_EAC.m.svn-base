...
scell{1} = set(s,...
    ...
    'stepSize',-0.0015,... %     'stepSize',-0.0005,...
    'initialValue',-0.0025,...
    'stimDistance',0.275,...
...
scell{1} = set(scell{1},'pedestal',0.355); 
scell{1} = set(scell{1},'initialValue', -0.0025);
scell{1} = set(scell{1},'stepSize',-0.0125);
...
% scell{2} = set(scell{2},'initialValue', 0.000);
% scell{2} = set(scell{2},'stepSize',0.0002);
% % scell{2} = set(scell{2},'stepSize',0.0005);
% 
% scell{3} = scell{2};
...
% scell{5} = set(scell{5},'initialValue', -0.0025);
% scell{5} = set(scell{5},'stepSize',-0.0125);
% % scell{5} = set(scell{5},'stepSize',-0.005);
% 
% scell{6} = scell{4};
