...
scell{1} = set(s,...
    ...
    'stepSize',0.00025,... %     'stepSize',-0.0005,...
    'initialValue',0.001,...
    'stimDistance',0.275,...
...
% scell{1} = set(scell{1},'initialValue', 0.00001);
% scell{1} = set(scell{1},'stepSize',0.001);

scell{1} = scell{1};
scell{1} = set(scell{1},'pedestal',0.315); 
scell{1} = set(scell{1},'initialValue', 0.0001);
...
% scell{4} = scell{1};
% scell{4} = set(scell{4},'pedestal',0.375); 
...
% scell{7} = set(scell{7},'initialValue', -0.040);
