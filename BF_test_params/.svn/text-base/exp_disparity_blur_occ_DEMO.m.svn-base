...
depth_step = .03;                  % Retrieve disparity (aka depth interval) (m)
db_stim_type = 0;                   % Retrieve stimulus type (0 = disp. only, 1 = blur only, 2 = both)
pedestal = 0.295;                    % Retrieve pedestal (m) (choose 0.37 or 0.30)
