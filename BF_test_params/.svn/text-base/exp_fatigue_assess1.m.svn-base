...
experiment_type='fatigue_assess1'; % Experiment for measuring visual fatigue, staircase method
...
trialspercorrfreq=2; %number of trials per one corrugation frequency
...
break_duration=15; %Time duration for break between assessments
