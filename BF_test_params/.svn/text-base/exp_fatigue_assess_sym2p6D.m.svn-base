...
experiment_type='fatigue_assess_sym2p6D'; % Experiment for measuring visual fatigue, staircase method
...
trialspercorrfreq=73; %number of trials per one corrugation frequency
...
break_time=60*30; %Time duration for break between assessments
stimulus_time=1.5; %Time duration for one stimulus. This is equal to the phase2_duration of scell.
