...
t_freq_permutations=[1 2 3;1 2 3;1 2 3;1 2 3;1 2 3;1 2 3]; % permutations of temporal frequencies
% this is training session. condition record is meaningless, just to keep
% the formating of 'exp_fatigue_time_5'
conditionrecordfilename = [pwd '/BF_data_files/Temporal_VA_conflict/condition_record/fatigue_time_5_training_condition_record.txt'];
...
% 		finished_conditions=t_finished(ii);
		finished_conditions=0; % training starts always from the beginning
		break;
