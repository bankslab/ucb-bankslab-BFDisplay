...
trialspercorrfreq=50; %number of trials per one corrugation frequency
...
relative_vergence2=lowconflictp2t*triangular_normalized(mod(temp_index,10)); % 0.1 Hz, triangular waveform
