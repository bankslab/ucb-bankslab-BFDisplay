...
scell{2} = set(scell{2}, 'condition_num',4,...
...
scell{3} =  scell{1};
% Set the correct stimulus params
scell{3} = set(scell{3}, 'condition_num',8,...
...
scell{4} =  scell{1};
% Set the correct stimulus params
scell{4} = set(scell{4}, 'condition_num',16,...
...
scell{5} =  scell{1};
% Set the correct stimulus params
scell{5} = set(scell{5}, 'condition_num',22,...
...
scell{6} =  scell{1};
% Set the correct stimulus params
scell{6} = set(scell{6}, 'condition_num',18,...
...
scell{7} =  scell{1};
% Set the correct stimulus params
scell{7} = set(scell{7}, 'condition_num',20,...
    'phase2_verg_dist', MidpointMidNearDist,...
    'phase2_accom_dist', MidpointFarMidDist);
