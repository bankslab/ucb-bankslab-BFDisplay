...
scell{2} = set(scell{2}, 'condition_num',17,...
...
scell{3} =  scell{1};
% Set the correct stimulus params
scell{3} = set(scell{3}, 'condition_num',18,...
    'phase2_verg_dist', MidpointMidMidDist,...
    'phase2_accom_dist', MidNearDist);
...
scell{4} =  scell{1};
% Set the correct stimulus params
scell{4} = set(scell{4}, 'condition_num',19,...
...
scell{5} =  scell{1};
% Set the correct stimulus params
scell{5} = set(scell{5}, 'condition_num',20,...
    'phase2_verg_dist', FarMidDist,...
    'phase2_accom_dist', MidpointMidMidDist);
...
scell{6} =  scell{1};
% Set the correct stimulus params
scell{6} = set(scell{6}, 'condition_num',21,...
    'phase2_verg_dist', MidNearDist,...
    'phase2_accom_dist', MidpointMidMidDist);
...
scell{7} =  scell{1};
% Set the correct stimulus params
scell{7} = set(scell{7}, 'condition_num',22,...
    'phase2_verg_dist', FarMidDist,...
    'phase2_accom_dist', FarMidDist);

scell{8} =  scell{1};
% Set the correct stimulus params
scell{8} = set(scell{8}, 'condition_num',23,...
    'phase2_verg_dist', MidpointMidMidDist,...
    'phase2_accom_dist', FarMidDist);

scell{9} =  scell{1};
% Set the correct stimulus params
scell{9} = set(scell{9}, 'condition_num',24,...
    'phase2_verg_dist', MidNearDist,...
    'phase2_accom_dist', FarMidDist);
