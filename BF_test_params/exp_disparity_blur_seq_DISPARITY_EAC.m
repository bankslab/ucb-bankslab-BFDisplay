...
scell{1} = set(s,...
    ...
    'phase3_duration',0.500,...     % Inter-stimulus duration
...
scell{2} = set(scell{2},'initialValue', 0.00);
...
scell{3} = set(scell{3},'stepSize',-0.004);
% scell{3} = set(scell{3},'stepSize',-0.005);

scell{4} = scell{3};
scell{4} = set(scell{4},'pedestal',0.335); 
scell{4} = set(scell{4},'initialValue', -0.035);
scell{4} = set(scell{4},'stepSize',-0.004);
% scell{4} = set(scell{4},'stepSize',-0.005);

scell{5} = scell{4};
scell{5} = set(scell{5},'pedestal',0.355); 
scell{5} = set(scell{5},'initialValue', -0.055);
scell{5} = set(scell{5},'stepSize',-0.004);
% scell{5} = set(scell{5},'stepSize',-0.005);

scell{6} = scell{4};
scell{6} = set(scell{6},'pedestal',0.375); 
scell{6} = set(scell{6},'initialValue', -0.08);
...
scell{7} = set(scell{7},'stepSize',-0.003);
