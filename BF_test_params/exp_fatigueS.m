% 'S' means 'SHORT.' This is a test version for displaying image in break.
...
experiment_type='fatigue_assess2'; % Experiment for measuring visual fatigue, staircase method
...
stimulus_duration=0.5; %Time duration for one stimulus. This is equal to the phase2_duration of scell.
oddity_question_duration=0.5; %Time duration for the questions between trials
