...
howmanycorrfreq=10; %number of corrugation frequencies
trialspercorrfreq=5; %number of trials per one corrugation frequency
...
break_duration=60*5; %Time duration for break between assessments
stimulus_duration=2; %Time duration for one stimulus. This is equal to the phase2_duration of scell.
oddity_question_duration=1.5; %Time duration for the questions between trials
