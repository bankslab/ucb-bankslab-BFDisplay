...
experiment_type='fatigue_assess_sym_training'; % Experiment for measuring visual fatigue, staircase method
...
trialspercorrfreq=72; %number of trials per one corrugation frequency
...
break_duration=60*30; %Time duration for break between assessments
...
fatigue_question_period=2; %fatigue question appears once per this number in "corrfreq for loop."
