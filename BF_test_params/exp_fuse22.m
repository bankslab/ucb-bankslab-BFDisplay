...
scell{3} =  scell{1};
% Set the correct stimulus params
scell{3} = set(scell{3}, 'condition_num',7,...
...
scell{4} =  scell{1};
% Set the correct stimulus params
scell{4} = set(scell{4}, 'condition_num',5,...
...
scell{5} =  scell{1};
% Set the correct stimulus params
scell{5} = set(scell{5}, 'condition_num',6,...
...
scell{6} =  scell{1};
% Set the correct stimulus params
scell{6} = set(scell{6}, 'condition_num',8,...
...
scell{7} =  scell{1};
% Set the correct stimulus params
scell{7} = set(scell{7}, 'condition_num',2,...
...
scell{9} =  scell{1};
% Set the correct stimulus params
scell{9} = set(scell{9}, 'condition_num',22,...
    'phase2_verg_dist', MidpointMidMidDist,...
    'phase2_accom_dist', MidpointMidNearDist);

scell{10} =  scell{1};
% Set the correct stimulus params
scell{10} = set(scell{10}, 'condition_num',20,...
    'phase2_verg_dist', MidpointMidNearDist,...
    'phase2_accom_dist', MidpointMidMidDist);

scell{11} =  scell{1};
% Set the correct stimulus params
scell{11} = set(scell{11}, 'condition_num',14,...
    'phase2_verg_dist', MidNearDist,...
    'phase2_accom_dist', FarDist);
