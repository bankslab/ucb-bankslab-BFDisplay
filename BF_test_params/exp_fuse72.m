...
scell{1} = set(s,...
    ...
    'rds_grating_cpd', 1.4,...
    'rds_grating_disparity', 3);    %specified in arcmin
    

% % Copy to other staircases
scell{2} =  scell{1};
% Set the correct stimulus params
scell{2} = set(scell{2}, 'condition_num',9,...
...
scell{4} =  scell{1};
% Set the correct stimulus params
scell{4} = set(scell{4}, 'condition_num',11,...
...
scell{5} =  scell{1};
% Set the correct stimulus params
scell{5} = set(scell{5}, 'condition_num',12,...
    'phase2_verg_dist', MidpointFarMidDist,...
    'phase2_accom_dist', MidpointMidMidDist);
...
scell{6} =  scell{1};
% Set the correct stimulus params
scell{6} = set(scell{6}, 'condition_num',13,...
    'phase2_verg_dist', MidpointMidNearDist,...
    'phase2_accom_dist', MidpointMidMidDist);
...
scell{7} =  scell{1};
% Set the correct stimulus params
scell{7} = set(scell{7}, 'condition_num',14,...
    'phase2_verg_dist', MidpointFarMidDist,...
    'phase2_accom_dist', MidpointFarMidDist);

scell{8} =  scell{1};
% Set the correct stimulus params
scell{8} = set(scell{8}, 'condition_num',15,...
    'phase2_verg_dist', MidpointMidMidDist,...
    'phase2_accom_dist', MidpointFarMidDist);

scell{9} =  scell{1};
% Set the correct stimulus params
scell{9} = set(scell{9}, 'condition_num',16,...
    'phase2_verg_dist', MidpointMidNearDist,...
    'phase2_accom_dist', MidpointFarMidDist);
