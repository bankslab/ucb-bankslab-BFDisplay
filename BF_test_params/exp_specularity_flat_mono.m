...
for ii=1:19
    leftSpecFileName{ii,1}=['BF_texture_files/specOnly/spec_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p3.png'];
    leftSpecFileName{ii,2}=['BF_texture_files/specOnly/spec_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p2.png'];
    leftSpecFileName{ii,3}=['BF_texture_files/specOnly/spec_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p1.png'];
    rightSpecFileName{ii,1}=['BF_texture_files/specOnly/spec_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p3.png'];
    rightSpecFileName{ii,2}=['BF_texture_files/specOnly/spec_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p2.png'];
    rightSpecFileName{ii,3}=['BF_texture_files/specOnly/spec_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_2_p1.png'];
    leftTexFileName{ii,1}=['BF_texture_files/texOnly/tex_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p3.png'];
    leftTexFileName{ii,2}=['BF_texture_files/texOnly/tex_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p2.png'];
    leftTexFileName{ii,3}=['BF_texture_files/texOnly/tex_-3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p1.png'];
    rightTexFileName{ii,1}=['BF_texture_files/texOnly/tex_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p3.png'];
    rightTexFileName{ii,2}=['BF_texture_files/texOnly/tex_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p2.png'];
    rightTexFileName{ii,3}=['BF_texture_files/texOnly/tex_3_' num2str(floor(ii/10)) '.' num2str(mod(ii,10)) '0_p1.png'];
end
