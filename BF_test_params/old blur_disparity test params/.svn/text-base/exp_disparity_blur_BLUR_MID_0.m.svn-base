...
scell{1} = set(s,...
    ...
    'phase2_duration',1.150,...      % Stimulus duration
    'eccentricity',0,...            % Specified in arcmin
    'pedestal',0.33,...                % Defined relative to viewer (m)
...
scell{2} = set(scell{2},'initialValue', -0.025);
...
scell{3} = scell{1};
scell{3} = set(scell{3},'pedestal',0.33); 
...
scell{5} = scell{1};
scell{5} = set(scell{5},'pedestal',0.36); 
...
scell{6} = set(scell{6},'initialValue', -0.06);
scell{6} = set(scell{6},'initialValue_random_range', 0.01);

scell{7} = scell{1};
scell{7} = set(scell{7},'pedestal',0.39); 
scell{7} = set(scell{7},'initialValue', -0.07);
