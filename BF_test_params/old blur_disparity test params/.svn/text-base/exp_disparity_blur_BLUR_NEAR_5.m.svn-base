...
scell{1} = set(s,...
    ...
    'initialValue', -0.05,...
    'initialValue_random_range', 0.025,...
    'stepSize',.01,...
    'minValue',-300,...
    'maxValue',300,....
    'maxReversals',10,...
...
scell{7} = set(scell{7},'initialValue', -0.020);
scell{7} = set(scell{7},'initialValue_random_range', 0.0050);
scell{7} = set(scell{7},'stepSize',.001);
