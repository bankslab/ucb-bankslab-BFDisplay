...
% For this condition, have subjects EITHER respond which is blurrier, or which is farther away--whichever is more apparent
...
scell{5} = set(scell{5},'initialValue_random_range', 0.01);
