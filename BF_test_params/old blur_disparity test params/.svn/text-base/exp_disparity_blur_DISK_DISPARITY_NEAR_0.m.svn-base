...
scell{1} = set(s,...
    ...
    'pedestal',0.255,...            % Defined relative to viewer (m)
...
% scell{1} = set(scell{1},'pedestal',0.275);
% scell{1} = set(scell{1},'initialValue', -0.0075);
% scell{1} = set(scell{1},'initialValue_random_range', 0.0005);
% scell{1} = set(scell{1},'stepLimit',.00015625);
% scell{1} = set(scell{1},'stepSize',-0.0025);
...
scell{3} = scell{2};
scell{3} = set(scell{3},'pedestal',0.295);
scell{3} = set(scell{3},'initialValue', -0.015);
scell{3} = set(scell{3},'initialValue_random_range', 0.0025);
scell{3} = set(scell{3},'stepLimit',.0003125);
...
scell{4} = scell{3};
scell{4} = set(scell{4},'pedestal',0.315); 
...
% 
% scell{6} = scell{5};
% scell{6} = set(scell{6},'pedestal',0.325); 
