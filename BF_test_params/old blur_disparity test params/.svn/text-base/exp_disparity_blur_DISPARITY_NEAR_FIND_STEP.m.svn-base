...
scell{1} = set(s,...
    ...
    'blur_disparity_stim',0,...     % 0 = disparity only, 1 = blur only, 2 = both
...
scell{2} = set(scell{2},'initialValue', -0.10);
scell{2} = set(scell{2},'maxValue', -0.065);
scell{2} = set(scell{2},'stepSize', 0.0025);

scell{3} = scell{2};
scell{3} = set(scell{3},'pedestal',0.36);
scell{3} = set(scell{3},'initialValue', -0.09);
scell{3} = set(scell{3},'maxValue', -0.06);
scell{3} = set(scell{3},'stepSize', 0.0025);

scell{4} = scell{2};
scell{4} = set(scell{4},'pedestal',0.345); 
scell{4} = set(scell{4},'initialValue', -0.070);
scell{4} = set(scell{4},'maxValue', -0.035);
scell{4} = set(scell{4},'stepSize', 0.0025);

scell{5} = scell{4};
scell{5} = set(scell{5},'pedestal',0.33); 
scell{5} = set(scell{5},'initialValue', -0.040);
scell{5} = set(scell{5},'stepSize', 0.0025);
scell{5} = set(scell{5},'maxValue', -0.01);

scell{6} = scell{2};
scell{6} = set(scell{6},'pedestal',0.315);
scell{6} = set(scell{6},'initialValue', -0.035);
scell{6} = set(scell{6},'stepSize', 0.00125);
scell{6} = set(scell{6},'maxValue', 0.0);


scell{7} = scell{2};
scell{7} = set(scell{7},'pedestal',0.30); 
scell{7} = set(scell{7},'initialValue', -0.011);
scell{7} = set(scell{7},'stepSize', 0.001);
scell{7} = set(scell{7},'maxValue', 0.0);
