...
scell{1} = set(s,...
    ...
    'eccentricity',300,...            % Specified in arcmin
    'pedestal',0.35,...                % Defined relative to viewer (m)
    'blur_disparity_stim',2,...     % 0 = disparity only, 1 = blur only, 2 = both
...
scell{2} = set(scell{2},'initialValue', 0.03);
scell{2} = set(scell{2},'initialValue_random_range', 0.015);
scell{2} = set(scell{2},'stepSize',.0025);
scell{3} = scell{1};
scell{3} = set(scell{3},'pedestal',0.32); 
scell{4} = set(scell{3},'initialValue', 0.05);
scell{4} = set(scell{3},'initialValue_random_range', 0.025);
scell{3} = set(scell{3},'stepSize',.0025);
scell{4} = scell{1};
scell{4} = set(scell{4},'pedestal',0.305); 
scell{4} = set(scell{4},'initialValue', 0.03);
scell{4} = set(scell{4},'initialValue_random_range', 0.015);
scell{4} = set(scell{4},'stepSize',.0025);
scell{5} = scell{1};
scell{5} = set(scell{5},'pedestal',0.29); 
scell{5} = set(scell{5},'initialValue', 0.03);
scell{5} = set(scell{5},'initialValue_random_range', 0.015);
scell{5} = set(scell{5},'stepSize',.0025);
scell{6} = scell{1};
scell{6} = set(scell{6},'pedestal',0.275);
scell{6} = set(scell{6},'initialValue', 0.025);
scell{6} = set(scell{6},'initialValue_random_range', 0.0075);
scell{6} = set(scell{6},'stepSize',.0025);
