...
scell{1} = set(s,...
    ...
    'pedestal',0.395,...            % Defined relative to viewer (m)
    'blur_disparity_stim',1,...     % 0 = thin lines, 1 = 1/f disk
    'phase1_focusmult',1,...        % 0 = no accommodation 
    'monocular',2);                 % 1 = monocular (left eye) condition, 2 = monocular, but same stimulus as binocular condition    
